...
1. 申请变更流程：了解、记录、评估、提交、更新、通知、执行 （了解、书面记录、评估影响、PM提交给CCB、更新变更日志和项目管理计划、通知结果给相关方）
2. 变更有四种：预防，纠正，缺陷补救，更新
3. 质量审计：审计师要“识别”-最佳实践，“分享”-类似项目，“协助”-过程的改进，“积累”-经验，“确认”-实施情况。由项目外部的团队开展。
4. 解决问题六步： 定义，识别，生成方案，选择，执行，验证
5. 采购：招、投、评、授
6. 收尾：总体形式验收、移交成果、总结教训、资产更新、文件归档、释放资源
7. 标杆对照：收集需求、规划质量、相关方数据收集
8. 三大基准：范围，进度，成本
9. 假设无效就是风险发生了
10. 问题日志：问题描述，责任人，解决期限
...
（1）制定项目章程 - 发起人批准，PM责任和权利 ，商业论证：商业需求和成本效益分析
...
* 成本加固定费用CPFF
* 成本加激励费用CPIF，限制利润就先算利润，限制总价先算总价 
* 成本加奖励费用CPAF，主观奖励

工料合同：适用于无法快速编制出准确工作说明书，短期
