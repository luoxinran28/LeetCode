...
您好，我叫罗欣然。在2015年的时候，我从犹他大学计算机硕士毕业，当时主要学习数据分析方向。毕业之后我就作为软件工程师加入了现在这家公司，戴尔EMC。戴尔EMC是全球存储器、服务器和云管理的领导者。而我主要帮助在dellemc.com上面展示并销售他们的产品及服务。我很喜欢学习，我从事过前后端的开发，并在公司的资助下，我拿到了我的MBA学位。

日常工作中，我主要是一名前端开发人员，使用Adobe旗下的一款内容管理系统来创造组件，那市场部门的同事们就使用我们创造的组件来创立网站页面去提供他们展示的包括文字、图片、文档、视频等内容。在此期间，我们就根据他们的使用反馈来迭代我们日常开发。这里我们使用的是敏捷开发模型进行日常的迭代。

作为一名小组领导，我需要跟我的经理以及交互设计师进行交流，一起预估我们的开发时间以及优先级，我需要审查我同事的代码并且将我们的工作在展示会议上进行演示。我们的前端代码必须要考虑如浏览器兼容性、国际语言、性能及阅读顺序等等情况。我最近的一个项目就是将我们主页的搜索引擎替换到Coveo框架，由于这个将影响到整个网站的用户体验，我们要不断的跟不同部门去沟通解释可能受到影响的地方。另一个项目是创建一个表单组件，用来代替现在用html写死的表单，这样我们的市场部门就可以重复使用这个组件来创造具有相同体验的表单。
...
## **Tiktok: Develop a company as a product**

真诚效率。OKR \(Objectives and Key Results\) not KPI \(Key Performance Indicator\). 企业文化：字节范（坦诚清晰）

为什么要加入字节跳动？

1. 我想要加入一家更具有活力的公司去证明自己的能力，在快速迭代的产品开发中不断去增强我对技术的理解以及管理协调能力。字节跳动旗下众多的产品提供了一个很好的平台，而Tiktok的国际影响力决定了开发人员必须做到高效且稳定，需要对产品开发做到一丝不苟才行，这对我来说是一个非常好的机会去证明我自己。
2. 我很喜欢字节范这个文化，不断创业追求极致也是我想要对我的要求，我现在所处的公司做很难做到像字节跳动这样不断迭代产品的氛围。我很希望能够和字节跳动员工一道，一起去开拓中国软件出海这条路。

为什么要选择广告组？[https://ads.tiktok.com/homepage/](https://ads.tiktok.com/homepage/)

目前广告收入占到了字节跳动收入非常大的一头，字节跳动在今年上半年占互联网广告的市场份额为23%，是仅次于阿里巴巴的中国第二大数字广告商。TikTok在全球范围内地不断增长，将会是字节跳动全球收入最为关键的一环，所以广告组非常重要而且压力很大，但这也正是我想不断挑战自己的地方，到需要的地方去，这也会让我觉得我的工作更加的有意义，更能为公司创造更大的商业价值。



前端开发工程师不只是写HTML、CSS和Javascript，还可以在多媒体领域里施展拳脚。比如替换Flash的H5播放器、各种协议的直播、交互视频等等

我很喜欢这种夹杂着对B和对C的业务。

面试失败总结：我觉得面试表现得不是很自然，说话方式太多不确定性，比如说了许多类似吧、可能、也许等等词汇，没有让人觉得很自信自己的实力，而且我的技术栈太陈旧了，对方用的技术栈比较新，如果我要证明我有能力学习以及胜任这份工作，应该在面试之前就去了解和学习这些技术，而不是等着拿到工作之后再去学习。我没有具有说服力和挑战性的项目去支撑我的技术水平，应该用实际行动去证明我的学习能力才是。
